...
CODEBERG_RAW="https://codeberg.org/X27/X-Linuxtool/raw/branch/main/Desktop/Linux-Desktop/Gaming"
GITHUB_RAW="https://raw.githubusercontent.com/GamerX27/X-Linuxtool/main/Desktop/Linux-Desktop/Gaming"
...
MENU_LABELS=("Proton-CachyOS" "Wine" "Gaming Setup" "Back")
LAST_MENU_INDEX=3
...
while true; do
    ...
    if [ "$INPUT" = "/dev/tty" ]; then
        if ui_pick "Proton / Wine & Gaming" "${MENU_LABELS[@]}"; then
